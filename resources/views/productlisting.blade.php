                        ...
                        <div class="card text-center mb-3">
                            <div class="card-body p-2 d-flex flex-column text-center">
                                ...
                                <a href="{{route('product.product_detail',$product->slug)}}">
                                  <img class="avatar avatar-lg mr-3 onerror-image" style="width: 100%"; src="{{ \App\CentralLogics\Helpers::onerror_image_helper( $product['image'] ?? '', asset('storage/app/public/product').'/'.$product['image'] ?? '', asset('public/assets/admin/img/160x160/img2.jpg'),'product/') }}" data-onerror-image="{{asset('public/assets/admin/img/160x160/img2.jpg')}}" alt="{{$product->name}} image">
                                </a>
