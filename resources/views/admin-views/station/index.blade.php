                            ...
                            id="default-form">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name[]" id="default_name"
                                        class="form-control" placeholder="{{ translate('messages.station_name') }}"
                                        required>
                                </div>
                                ...
                                <div class="form-group mb-0">
                                    ...
                                    <textarea type="text" name="address[]" placeholder="{{translate('messages.station')}}" class="form-control min-h-90px ckeditor"></textarea>
                                </div>
                            </div>
                                @foreach (json_decode($language) as $lang)
