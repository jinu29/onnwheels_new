    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <h1 class="page-header-title">
                ...
                <span>
                    {{ translate('messages.add_new_station') }}
                </span>
            </h1>
        </div>
        ...
        @php($defaultLang = 'en')
        <!-- End Page Header -->a
        <form action="{{ route('admin.store.station-store') }}" method="post" enctype="multipart/form-data"
                                ...
                                <div class="lang_form" id="default-form">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name[]" id="default_name" class="form-control"
                                            placeholder="{{ translate('messages.station_name') }}" required>
                                    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            $('#scheduleForm').on('submit', function(event) {
                ...
                // Append hidden inputs to the container
                $('#hiddenInputsContainer').append(`
                <input type="hidden" name="day[]" value="${dayId}">
                <input type="hidden" name="opening_time[]" value="${startTime}">
                <input type="hidden" name="closing_time[]" value="${endTime}">
            `);
