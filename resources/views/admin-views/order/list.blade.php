                    ...
                    <form class="search-form min--260">
                        ...
                        <div class="input-group input--group">
                            <input id="datatableSearch_" type="search" name="search" class="form-control h--40px"
                                placeholder="{{ translate('messages.Ex:') }} 10010" value="{{ request()?->search ?? null }}"
                        ...
                        <tbody>
                            @foreach ($orders as $key => $order)
                                <tr>
                                    ...
                                    <td>
                                        @if ($order->details)
                                            {{ $order->details[0]['item']->bike->name }}
                                        @else
                                            N/A
                                        @endif
                                    </td>
                                    <td>
                                        @if ($order->details && $order->details[0]['item'])
                                        @foreach ($order->details[0]['item']->stations as $station)
